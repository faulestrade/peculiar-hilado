...
const BANNER_QUERY = `
  SELECT b.*, p.name as product_name, p.slug as product_slug, p.price as product_price,
...
async function upsert(req, res) {
  ...
  try {
    ...
    // If activating a new banner, deactivate others
...
module.exports = { getActive, getAll, upsert, toggleActive, remove };
